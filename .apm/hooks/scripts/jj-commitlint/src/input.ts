...
// 出典: Claude(hooks docs, Bashツール)、Codex(codex-rs/hooks/src/events/pre_tool_use.rs)、Gemini(packages/core/src/hooks/types.ts BeforeToolInput + tools/shell.ts ShellToolParams.command)。
